...
namespace tml
{
    struct Color
    {
        TML_API Color() = default;
        TML_API constexpr Color(uint8_t r, uint8_t g, uint8_t b) : r(r), g(g), b(b), a(255) {}
        TML_API constexpr Color(uint8_t r, uint8_t g, uint8_t b, uint8_t a) : r(r), g(g), b(b), a(a) {}
        TML_API explicit constexpr Color(uint32_t hex) noexcept
            : r((hex & 0xff000000) >> 24),
            g((hex & 0x00ff0000) >> 16),
            b((hex & 0x0000ff00) >> 8),
            a((hex & 0x000000ff))
        ...
        TML_API constexpr Color(int32_t hex) noexcept
            : r((hex & 0xff000000) >> 24),
            g((hex & 0x00ff0000) >> 16),
            b((hex & 0x0000ff00) >> 8),
            a((hex & 0x000000ff))
        ...
        TML_API inline constexpr Color operator/(float rhs) const noexcept {
        ...
        TML_API inline constexpr Color operator+(const Color& color) const noexcept {
        ...
        TML_API inline constexpr uint32_t Hex() const noexcept {
