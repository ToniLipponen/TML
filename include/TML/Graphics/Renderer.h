...
namespace tml
{
    ...
    public:
        ...
        void Draw(Rectangle& rectangle) noexcept;
        void Draw(Circle& circle) noexcept;
        void Draw(Sprite& sprite) noexcept;
        void Draw(Text& text) noexcept;
        void Draw(Video& video) noexcept; /// @warning You need to call video.Advance() before drawing
        ...
        void DrawTexture(Texture& tex, const Vector2f& pos, const Vector2f& size) noexcept;
        void DrawTextureRect(Texture& tex, const Vector2f& pos, const Vector2f& size, float rotation, const Vector2f& tl, const Vector2f& br) noexcept;
        ...
        */
        ...
        void PushVertexData(std::vector<Vertex>& vertices, std::vector<ui32>& indices) noexcept;
        void PushVertexData(std::vector<Vertex>& vertices, std::vector<ui32>& indices, Texture& texture) noexcept;
    protected:
        ...
        ui32 PushTexture(Texture&) noexcept;
