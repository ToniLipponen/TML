...
namespace tml
{
    ...
    public:
        ...
        bool LoadFromFile(const std::string& vs, const std::string& fs) const noexcept;
        bool LoadFromString(const std::string& vs, const std::string& fs) const noexcept;
    ...
    private:
        void Cleanup(uint32_t vs, uint32_t fs) const noexcept;
