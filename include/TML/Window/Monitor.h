...
namespace tml
{
    ...
    public:
        ...
        /// Returns the GLFW handle of the monitor.
        [[nodiscard]] 
        ...
        /// Returns the position of the monitor within a multi-monitor surface.
        [[nodiscard]] 
        Vector2i GetPosition() const noexcept;
        
        /// Returns the work area position.
        [[nodiscard]] 
        Vector2i GetWorkAreaPosition() const noexcept;
        
        /// Returns the available work area size.
        [[nodiscard]] 
        Vector2i GetWorkAreaSize() const noexcept;
        
        /// Returns the physical size of the monitor in millimeters.
        [[nodiscard]] 
        Vector2i GetPhysicalSize() const noexcept;
        
        /// Returns the size of the monitor in inches.
        [[nodiscard]] 
        float GetDiagonalSize() const noexcept;
        
        /// Returns monitor gamma.
        [[nodiscard]] 
        float GetGamma() const noexcept;
        
        /// Returns the UI scale as a Vector2.
        [[nodiscard]] 
