...
namespace tml::File
{
    ...
    TML_API std::vector<char> Decompress(const void* data, int32_t bytes, int32_t maxSize) noexcept;
    ...
    TML_API std::vector<char> Decompress(const std::vector<char>& data, int32_t maxSize) noexcept;
}