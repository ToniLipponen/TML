...
namespace tml
{
    namespace Interface
    {
        ...
        public:
            ...
            void SetValue(ui32 index, std::wstring value); // Set index to value.
            std::wstring GetValue(ui32 index); // @brief Returns an empty string if index is greater than list size - 1.
