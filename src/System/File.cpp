...
namespace tml::File
{
    ...
    std::vector<char> GetBytes(const std::string& filename) noexcept
    {
    ...
    std::string GetString(const std::string& filename) noexcept
    {
        if(std::filesystem::exists(filename))
        {
    ...
    std::vector<std::string> GetLines(const std::string& filename) noexcept
    {
        if(std::filesystem::exists(filename))
        {
